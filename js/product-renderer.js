  ...
  createCardHTML(product) {
    ...
    return `
      <div class="product-card ${outOfStock ? 'out-of-stock' : ''}"
           ...
           data-category="${product.subFilter || product.subCategory || ''}"
        ...
        <div class="product-image" onclick="window.location.href='${productLink}'" style="cursor: pointer;">
          <img src="${mainImg}" alt="${product.name}" loading="lazy" onerror="this.src='${prefix}Images/Category/western-wear.jpg'">
        </div>

        <div class="product-info">
          <h3 onclick="window.location.href='${productLink}'" style="cursor: pointer;">${product.name}</h3>
          <div class="price">
